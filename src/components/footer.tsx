export default function Footer() {
  ...
  return (
    <footer className="py-8 glass-card mt-16">
      <div className="container text-center">
        <div className="mb-4">
          <h3 className="text-lg font-medium text-primary">Dr. Mili Jain</h3>
          <p className="text-sm text-muted-foreground">Physiotherapist</p>
        </div>
        
        <div className="flex justify-center space-x-6 mb-6">
          <a href="mailto:physiojainmili23@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
          ...
          <a href="tel:8302074388" className="text-muted-foreground hover:text-primary transition-colors">
        ...
        <div className="text-sm text-muted-foreground">
          <p>&copy; {currentYear} Dr. Mili Jain. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
